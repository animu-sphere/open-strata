...
The v0.23.0 implementation is recorded in the
[release record](../releases/v0.23.0.md). This page tracks the remaining
acceptance and the next feature work.

## Post-release v0.23.0 evidence
...
- Run a clean-host configure, link and test against a republished, digest-pinned
  OpenUSD runtime whose CMake exports contain no producer-local Python paths.
