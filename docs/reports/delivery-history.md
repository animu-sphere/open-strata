# Delivery history (pre-reorg roadmap detail)

This is the granular delivery log for OpenStrata v0.1.0–v0.12.0: the completed
phase work and the dogfooding-derived backlogs that drove each release. It is
**historical evidence**, retained verbatim from the original roadmap — not a
description of current behavior (see [architecture/](../architecture/) and
[reference/](../reference/)) or of planned work (see [roadmap/](../roadmap/)).

Per-version summaries live in [releases/](../releases/); design rationale lives in
[design/](../design/).
...
The cross-cutting delivery areas below record both shipped work and, as of the
reorganization, open items. Open items are tracked forward in
[roadmap/backlog.md](../roadmap/backlog.md); the shipped detail is retained here.
