...
| [USD Point Cloud report #4 — HTTP resolver pre-implementation](https://github.com/animu-sphere/usd-pointcloud-plugins/blob/main/docs/reports/ost/04-2026-08-16-usd-http-resolver-preimplementation.md) | Resolver skeleton readiness: OST environment resolution passed; missing bundle/backend/CI/tests are downstream gates and request no OST change. |
